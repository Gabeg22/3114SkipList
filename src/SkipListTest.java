...
public class SkipListTest extends TestCase {
    ...
    public void testInsert() {
        ...
        KVPair<String, Rectangle> pair = new KVPair<String, Rectangle>("b", test);
        sl.insert(pair);
        assertEquals(1,sl.size());
        ArrayList<KVPair<String, Rectangle>> search = new ArrayList<KVPair<String, Rectangle>>();
        search = sl.search("b");
        assertEquals(search.get(0).getValue(),test);
        
        //insert after head element
        KVPair<String, Rectangle> pair2 = new KVPair<String, Rectangle>("d", test);
        sl.insert(pair2);
        search = sl.search("b");
        ...
        KVPair<String, Rectangle> pair3 = new KVPair<String, Rectangle>("c", test);
        sl.insert(pair3);
        search = sl.search("c");
        ...
        KVPair<String, Rectangle> pair4 = new KVPair<String, Rectangle>("a", test);
        sl.insert(pair4);
        search = sl.search("a");
    ...
    public void testRemove() {
        ...
        KVPair<String, Rectangle> pair2 = new KVPair<String, Rectangle>("c", test);
        sl.insert(pair);
        sl.insert(pair2);
