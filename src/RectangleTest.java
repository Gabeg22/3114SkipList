...
public class RectangleTest extends TestCase {
    ...
    public void test_equals() {
        ...
        Rectangle r7  = new Rectangle(1, 0, 6, 5);   // x and width false, others true
        Rectangle r8  = new Rectangle(1, 0, 5, 6);   // x and height false, others true
        Rectangle r9  = new Rectangle(0, 1, 6, 5);   // y and width false, others true
        Rectangle r10 = new Rectangle(0, 1, 5, 6);   // y and height false, others true
        Rectangle r11 = new Rectangle(0, 0, 6, 6);   // width and height false, others true
    ...
    public void test_isInvalid() {
        ...
        Rectangle r2  = new Rectangle(512, 1100, 600, 50);   // x valid, y invalid, x+width invalid, y+height invalid
        Rectangle r3  = new Rectangle(-100, 512, 600, 50);   // x invalid, y valid, x+width invalid, y+height invalid
        Rectangle r4  = new Rectangle(1100, 1100, 50, 10);   // x invalid, y invalid, x+width valid, y+height invalid
        Rectangle r5  = new Rectangle(1100, 1100, 10, 50);   // x invalid, y invalid, x+width invalid, y+height valid
        Rectangle r6  = new Rectangle(512, 512, 600, 600);   // x valid, y valid, x+width invalid, y+height invalid
        Rectangle r7  = new Rectangle(-100, 512, 50, 600);   // x invalid, y valid, x+width valid, y+height invalid
        Rectangle r8  = new Rectangle(-100, 512, 600, 50);   // x invalid, y valid, x+width invalid, y+height valid
        Rectangle r9  = new Rectangle(512, 1100, 50, 600);   // x valid, y invalid, x+width valid, y+height invalid
        Rectangle r10 = new Rectangle(512, 1100, 600, 50);   // x valid, y invalid, x+width invalid, y+height valid
        Rectangle r11 = new Rectangle(512, 512, 50, 600);    // x valid, y valid, x+width valid, y+height invalid
        Rectangle r12 = new Rectangle(512, 512, 600, 50);    // x valid, y valid, x+width invalid, y+height valid
        Rectangle r13 = new Rectangle(512, 1100, 50, 50);    // x valid, y invalid, x+width valid, y+height valid
        Rectangle r14 = new Rectangle(-100, 512, 50, 50);    // x invalid, y valid, x+width valid, y+height valid
        Rectangle r15 = new Rectangle(1100, 1100, 50, 50);   // x invalid, y invalid, x+width valid, y+height valid
        Rectangle r16 = new Rectangle(512, 512, 100, 100);   // All conditions false (Valid Rectangle)
